...
const props = defineProps<{
  ...
  // biome-ignore lint/correctness/noVueDuplicateKeys: local ref of the same name intentionally shadows this prop to implement v-model via @vueuse/core's useVModel
